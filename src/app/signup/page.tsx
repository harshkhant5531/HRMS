...
import { Lock, Mail, User, IdCard, Loader2, ArrowRight, Briefcase, Zap } from "lucide-react";
                ...
                <div className="bg-[#1a1d23]/80 backdrop-blur-3xl border border-white/5 p-12 rounded-[40px] shadow-2xl">
                    <div className="text-center mb-12">
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-500/10 text-blue-400 text-[10px] font-black uppercase tracking-[0.2em] mb-4">
                            <Zap className="w-3 h-3" /> Registration
                        </div>
                        <h1 className="text-4xl font-black tracking-tighter text-white">
                            Create <span className="bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent italic px-1">Account</span>
                        </h1>
                        <p className="text-gray-500 mt-3 font-medium">Join the Dayflow team.</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative group">
                                    <IdCard className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-600 group-focus-within:text-blue-500 transition-colors" />
                                    <input
                                        type="text"
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative group">
                                <Briefcase className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-600 group-focus-within:text-blue-500 transition-colors" />
                                <select
                                    value={formData.role}
                                    onChange={(e) => setFormData({ ...formData, role: e.target.value })}
                                    className="w-full bg-[#0f1115] border border-white/5 rounded-2xl py-4 pl-12 pr-4 focus:outline-none focus:ring-2 focus:ring-blue-500/30 transition-all text-sm font-bold appearance-none cursor-pointer text-gray-400"
                                >
